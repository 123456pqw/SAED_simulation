...
parser.add_argument("-root_dir", type=str, default="/internfs/pengqianwen/MVBBCNN/data")
...
if __name__ == '__main__':
    ...
    split_dict = split_by_spacegroup(spacegroup_to_materials,args.root_dir, num_views=3,seed=12, val_ratio=0.15, test_ratio=0.15)
